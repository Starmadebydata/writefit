...
// 旧计划 → 环境变量名 映射（本次：live 环境 UI 创建的计划）
const OLD_PLANS = [
  { envKey: "PAYPAL_PLAN_BASIC_MONTHLY", id: "P-83S99682PR7690201NJOOH4Y" },
  { envKey: "PAYPAL_PLAN_BASIC_YEARLY", id: "P-57S65863BV488404ANJOOJTI" },
  { envKey: "PAYPAL_PLAN_PRO_MONTHLY", id: "P-9SA41618T4861835ANJOOK3Y" },
  { envKey: "PAYPAL_PLAN_PRO_YEARLY", id: "P-6C029587UD3527705NJOOM2Y" },
];
